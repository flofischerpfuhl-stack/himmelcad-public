...
| WP-A7   | Neural matching model k² × 4 B × 3 attention layers + 256 MiB base per worker; SIFT 256 MiB per worker                                                                     | Calibrated so 24,000 keypoints ≈ 7.2 GB (measured ≈ 7 GB per worker at the OOM); SIFT measured below 256 MiB on Sulzberg                     |
