...
| --------------------------- | ----------------------------------------------- | ------------------------------------------------------------------------------ | --------------------------- | --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `measure.point`             | Inspect · Measure                               | R split menu; X **Save point measurement**; C; A                               | VT                          | cont acquisition; bnd commit      | `measurement.create` (`kind: point`)                                                                                                | Release 0.5 point profile; implemented by 0.5-08                                                                                                                                                                                                                                                              |
| `measure.distance`          | Inspect · Measure                               | R split primary/menu; X **Start distance here**; C; A                          | VT                          | cont acquisition/edit; bnd commit | `measurement.create` (`kind: distance`, metric Spatial or Horizontal)                                                               | Release 0.5 2D/3D distance profile; implemented by 0.5-08                                                                                                                                                                                                                                                     |
...
| `measure.dz`                | Inspect · Measure                               | R split menu; X **Measure height difference**; C; A                            | VT                          | cont acquisition/edit; bnd commit | `measurement.create` (`kind: heightDifference`)                                                                                     | Release 0.5 profile row; implemented by 0.5-08                                                                                                                                                                                                                                                                |
...
| `measurement.list`         | Inspect · Measure                               | R pure toggle; X on measurement **Open measurement**; C; A                     | RP                          | bnd                               | `measurement.list/get`                                                                                                              | Release 0.5 list subset; implemented by 0.5-08                                                                                                                                                                                                                                                                |
| `measurement.delete`       | Measurement context                             | X on measurement **Delete measurement**; C; A                                  | RP                          | bnd                               | `measurement.remove`                                                                                                                | Release 0.5 delete subset; implemented by 0.5-08                                                                                                                                                                                                                                                              |
