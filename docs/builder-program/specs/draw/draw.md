...
| `draw.line`             | Line: free (AP-EP), tangent from point to curve (AP-TE), tangent between two arcs (TA-TE) (rib-civil.md §2.1 Gerade)                                                                                                  | ribbon; console; automation                                                                                                    | VT                         | cont preview                        | `draw.line`; canonical `draw.curve.put` (lineSegment)                                                                             | 0.5-04 implements the free two-vertex subset over `LineSegment`; tangent variants remain GF                                                                                                                                                                                                                                                  |
| `draw.polyline`         | Polyline with line and arc segments, open/closed, join/reverse (rib-civil.md §2.1 Linienzug)                                                                                                                          | ribbon; console; automation; shortcut (registry)                                                                               | VT                         | cont                                | `draw.polyline`; canonical `draw.curve.put` (polyline/composite)                                                                  | 0.5-04 implements line-segment polyline creation, closure, provenance, and vertex journal compensation; mixed chains/join/reverse remain GF                                                                                                                                                                                                  |
| `draw.boundary`         | Closed boundary polygon from at least three vertices; clicking the first vertex closes                                                                                                                                | ribbon; console; automation                                                                                                    | VT                         | cont                                | `draw.boundary`; canonical `draw.curve.put` (closed polyline)                                                                     | implemented by 0.5-04 with boundary Mesh source role on closure                                                                                                                                                                                                                                                                              |
| `draw.vertex.add`       | Accept the active exact snapped point as the next vertex                                                                                                                                                              | viewport click; console; automation                                                                                            | shared input               | bnd                                 | `draw.vertex.add`                                                                                                                 | implemented by 0.5-04; point-acquisition provenance retained                                                                                                                                                                                                                                                                                 |
| `draw.vertex.constrain` | Add a vertex by 45°-snapped direction, length, and ΔZ or slope                                                                                                                                                        | shared input; console; automation                                                                                              | shared input               | bnd                                 | `draw.vertex.constrain`                                                                                                           | implemented by 0.5-04                                                                                                                                                                                                                                                                                                                        |
| `draw.vertex.type`      | Add a vertex by absolute X/Y/Z                                                                                                                                                                                        | shared input; console; automation                                                                                              | shared input               | bnd                                 | `draw.vertex.type`                                                                                                                | implemented by 0.5-04                                                                                                                                                                                                                                                                                                                        |
| `draw.vertex.undo`      | Compensate the latest accepted vertex transaction, then the entity-creation transaction                                                                                                                               | panel; console; automation                                                                                                     | VT                         | bnd                                 | `draw.vertex.undo`                                                                                                                | implemented by 0.5-04                                                                                                                                                                                                                                                                                                                        |
