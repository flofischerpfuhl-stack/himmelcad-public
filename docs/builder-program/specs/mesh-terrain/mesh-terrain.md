...
| `mesh.edit.region.select` | Edit                                     | docked **Edit surface** panel; console; automation                                                                           | projection-true fence or boundary polyline  | continuous                              | `mesh.edit.region.select`                                                                                                                                                      | implemented by 0.5-06; typed project-XY polygon; owner: mesh-terrain                                                                                          |
| `mesh.edit.smooth`      | Edit                                       | ribbon/context **Edit surface**; docked panel; console; automation                                                          | region + protected-constraint preview       | continuous preview; bounded→long bake   | `mesh.edit.smooth`                                                                                                                                                             | implemented by 0.5-06; immutable derived generation and deterministic cut/refill; owner: mesh-terrain                                                        |
| `mesh.edit.downsample`  | Edit                                       | **Edit surface** panel; context; console; automation                                                                         | certified preview/bake                      | bounded→long                            | `mesh.edit.downsample`                                                                                                                                                         | implemented by 0.5-06; certified maximum vertical error, deterministic bake; owner: mesh-terrain                                                             |
