...
| `pointcloud.sample`                   | Cloud                                           | ribbon "Sample…"; context; console; automation                                                           | docked/detachable function panel + UIP-D10 job    | long-running                             | `pointcloud.sample`                                                                                                      | Implemented — PC-D8 distance/grid/random baked prepared cloud with deterministic selection hash, P4 scope, provenance, source immutability, and undo                                                                                                                                                            |
...
| `pointcloud.rasterize`                | Pointcloud · Terrain                            | ribbon "Rasterize mean height…"; context; console; automation; Mesh hand-off                             | docked/detachable function panel + registered job | long-running                             | `pointcloud.rasterize`                                                                                                   | Implemented — batch-2 PC-D17 mean/min/max/count prepared grid; mean/min/max advertise the MT-D26 `grid_source` role, while count remains a non-height raster                                                                                                                                                     |
...
Registry entries applied by the round-3 rebuild: `pointcloud.rasterize` (ribbon/context/
