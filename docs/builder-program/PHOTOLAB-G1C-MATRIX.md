...
| DEM — DSM surface  | himmelcad-prepared-hierarchy@1 | **Blocked: invalid PhotoLab publication**               | same root, `product-e288ad8f…` (dem_facts: elevationZ, continuous connectivity, validity bitset)                                                                                                                                                                                                                                        | **PASS** — exact republished `2868864c…` identity and frozen lineage; [PL-B1b evidence](evidence/PL-B1b-durable-sync-dem-residency-2026-09-11.md#literal-builder-verification) | **PASS** — resident hierarchy renders with validity-mask holes; [PL-B1b evidence](evidence/PL-B1b-durable-sync-dem-residency-2026-09-11.md#dsm-product-2868864c) | **PASS** — 7/7 dense XYs and valid centre within 0.01 m; four corner holes empty; [PL-B1b evidence](evidence/PL-B1b-durable-sync-dem-residency-2026-09-11.md#dsm-product-2868864c) | **PASS** — visible Line reports `Snap: Face` at 7/7 valid dense XYs; [PL-B1b evidence](evidence/PL-B1b-durable-sync-dem-residency-2026-09-11.md#literal-builder-verification) |
| DEM — DTM surface  | himmelcad-prepared-hierarchy@1 | Available (republished 2026-09-10 01:39 with G1a-3c/3d) | `.build/photolab-e2e/g1a3-dtm-smoke/photolab-e2e.hcad/.photolab/product-import-packages/product-00e33bcd…` — `dem_facts.surface = dtm`, `ground_classification { sha256 a4ecae15…, algorithm_id smrf@1, parameters_sha256 234535f0… }`, tool entry `smrf@1`; older DTM packages (60af8cb2…, 3d43364e…) stay valid but lack these fields | **PASS** — exact `00e33bcd…` identity, frozen `dtm`/SMRF lineage and package hash; [PL-B1b evidence](evidence/PL-B1b-durable-sync-dem-residency-2026-09-11.md#literal-builder-verification) | **PASS** — resident hierarchy renders; four corner cells and centre remain transparent; [PL-B1b evidence](evidence/PL-B1b-durable-sync-dem-residency-2026-09-11.md#dtm-product-00e33bcd) | **PASS** — 7/7 dense XYs within 0.01 m and all five holes empty; [PL-B1b evidence](evidence/PL-B1b-durable-sync-dem-residency-2026-09-11.md#dtm-product-00e33bcd) | **PASS** — visible Line reports `Snap: Face` at 7/7 valid XYs and `Snap: —` at five holes; [PL-B1b evidence](evidence/PL-B1b-durable-sync-dem-residency-2026-09-11.md#literal-builder-verification) |
| dense mesh (tiled) | himmelcad-prepared-hierarchy@1 | publisher and reader unit-accepted; product smoke pending | Existing A3 result `.build/photolab-evidence/g1a3/mesh-smoke-result.json`; PL-I1 now inventories the complete prepared hierarchy, including glTF/render buffers and pages, with frozen lineage, hashes, and ready-last publication; [PL-I1 evidence](evidence/PL-I1-product-publishers-2026-09-19.md) | **NOT RUN** — no retained PL-I1 identity run | **NOT RUN** — product smoke prohibited in PL-I1 | **NOT RUN** — product smoke prohibited in PL-I1 | **NOT RUN** — product smoke prohibited in PL-I1 |
| orthomosaic | himmelcad-prepared-hierarchy@1 | publisher and reader unit-accepted; product smoke pending | Prepared RGB(A) raster hierarchy with plan-grid georeference facts and tile-local LSB0 alpha validity; frozen lineage, hashes, and ready-last publication; [PL-I1 evidence](evidence/PL-I1-product-publishers-2026-09-19.md) | **NOT RUN** — no retained PL-I1 product fixture | **NOT RUN** — product smoke prohibited in PL-I1 | **NOT RUN** — product smoke prohibited in PL-I1 | **NOT RUN** — product smoke prohibited in PL-I1 |
| gaussian splat     | himmelcad-prepared-hierarchy@1 | publisher and reader unit-accepted; product smoke pending | Prepared splat hierarchy with a typed kernel manifest and exact resource bindings; frozen lineage, hashes, and ready-last publication; [PL-I1 evidence](evidence/PL-I1-product-publishers-2026-09-19.md) | **NOT RUN** — no retained PL-I1 product fixture | **NOT RUN** — product smoke prohibited in PL-I1 | **NOT RUN** — product smoke prohibited in PL-I1 | **NOT RUN** — product smoke prohibited in PL-I1 |
...
| merged point cloud | —                              | not a release kind                                      | IF-D19–IF-D25 admit only sparse, dense, dem, orthomosaic, mesh, and gaussianSplat; PL-I1 does not invent a seventh product kind.                                                                                                                                                                                                           | **N/A** — not a release kind                                                                                      | **N/A** — not a release kind                                                                                                                                    | **N/A** — not a release kind                                                                                                               | **N/A** — not a release kind                                                                                      |
