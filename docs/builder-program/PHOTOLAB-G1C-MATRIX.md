...
| DEM — DSM surface | himmelcad-prepared-hierarchy@1 | Available (republished 2026-09-10 20:01 with G1a-3c/3d/3g) | `.build/photolab-e2e/g1a3-dsm-smoke/photolab-e2e.hcad/.photolab/product-import-packages/product-306545ca…` — `dem_facts.surface = dsm`, no ground_classification (DSM); older DSM packages (e288ad8f… invalid masks, 2868864c… pre-3c) superseded | to run | to run | to run | to run |
| DEM — DTM surface  | himmelcad-prepared-hierarchy@1 | Available (republished 2026-09-10 01:39 with G1a-3c/3d) | `.build/photolab-e2e/g1a3-dtm-smoke/photolab-e2e.hcad/.photolab/product-import-packages/product-00e33bcd…` — `dem_facts.surface = dtm`, `ground_classification { sha256 a4ecae15…, algorithm_id smrf@1, parameters_sha256 234535f0… }`, tool entry `smrf@1`; older DTM packages (60af8cb2…, 3d43364e…) stay valid but lack these fields | to run                                                                                                            | to run                                                                                                                                                        | to run                                                                                                                                   | to run                                                                                                            |
| dense mesh (tiled) | himmelcad-prepared-hierarchy@1 | Available (mesh smoke 2026-09-10 15:10) | `.build/photolab-e2e/g1a3-mesh-smoke/photolab-e2e.hcad/.photolab/product-import-packages/product-33915de9fd1f…` (textured DEM mesh, 100k faces smoke; chain depth → dense → dem → ortho → mesh — the texture needs the orthomosaic of the same lineage) | to run | to run | to run | to run |
| orthomosaic | himmelcad-prepared-hierarchy@1 | unsupported_format (orthomosaic builds and textures the mesh, but has no package publisher yet) | mesh smoke: `complete/unsupported_format` | — | — | — | — |
