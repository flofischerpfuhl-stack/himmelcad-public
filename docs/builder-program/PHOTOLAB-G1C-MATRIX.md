...
| DEM — DTM surface  | himmelcad-prepared-hierarchy@1 | Available (DTM smoke 09-09)  | `.build/photolab-e2e/g1a3-dtm-smoke/photolab-e2e.hcad/.photolab/product-import-packages/product-60af8cb2…` (dem_facts: elevationZ, SMRF ground classification `a4ecae15da7c26dc`) | to run                          | to run | to run | to run |
