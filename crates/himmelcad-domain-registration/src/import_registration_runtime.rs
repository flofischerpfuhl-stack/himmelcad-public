...
use himmelcad_transform::transform::{
    apply_similarity_3d, residual_report, Similarity3D, WorldPoint,
};
...
pub struct RegistrationSourceSamples {
    ...
    pub source_transform: Option<himmelcad_model::entity_model::Transform3d>,
...
impl ImportRegistrationRuntime {
    ...
    pub fn source_samples(
        ...
        if !(3..=crate::registration::MAX_ICP_SAMPLES_PER_CLOUD).contains(&maximum_samples) {
    ...
    pub fn preview_point_pairs(
        ...
        let preview = match model {
            himmelcad_transform::transform::EmpiricalModelKind::Translation3D => {
                fit_translation_point_pairs_3d(pairs, robust)?
            }
            himmelcad_transform::transform::EmpiricalModelKind::Rigid3D => {
                fit_point_pairs_3d(pairs, false, robust)?
            }
            himmelcad_transform::transform::EmpiricalModelKind::Similarity3D => {
...
fn sample_potree_root(
    ...
    placement: Option<himmelcad_model::entity_model::Transform3d>,
    maximum_samples: usize,
...
pub fn sample_potree_open_files(
    owner_id: &str,
    dataset_id: &str,
    ...
    fn interactive_recipe_starts_awaiting_fresh_input() {
        let recipe = RegistrationRecipe {
            ...
            method: RegistrationMethod::PointPairs {
                model: himmelcad_transform::transform::EmpiricalModelKind::Similarity3D,
