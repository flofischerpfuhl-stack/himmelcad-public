...
use himmelcad_core::entity_model::Transform3d;
#[cfg(test)]
use himmelcad_core::entity_model::{
    DepthSampling, GeometryObject, GeometryResource, RasterImageGeometry, TriangleMeshGeometry,
    TriangleMeshStorage,
};
...
pub use himmelcad_document::canonical_import::{
