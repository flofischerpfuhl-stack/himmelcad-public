...
use crate::photolab_gcp_optimization::{GcpSimilarityTransform, OptimizedGcpCamera};
...
pub fn compute_control_misclosure(
    ...
    left: &[crate::photolab_gcp_optimization::OptimizedGcpPoint],
    right: &[crate::photolab_gcp_optimization::OptimizedGcpPoint],
...
mod tests {
    ...
    fn computes_mean_absolute_shared_control_misclosure() {
        use crate::photolab_gcp::{GcpCoordinate, GcpPointId};
        use crate::photolab_gcp_optimization::OptimizedGcpPoint;
