...
use himmelcad_process::process_group::{self, ProcessGroupChild as Child};
...
use crate::photolab_jobs::{
    JobProgress, PhotolabMemoryDegradation, PhotolabStage, PhotolabStageKind,
};
use crate::photolab_masks::ImageMaskComputeScope;
