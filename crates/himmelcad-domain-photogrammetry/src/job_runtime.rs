...
use himmelcad_process::raster_jobs::RasterPreparationStagePlan;
...
mod tests {
    ...
    use super::*;
    use crate::photolab_jobs::{
        CheckpointDescriptor, JobProgress, NewPendingCheckpoint, NewPhotolabJob, PhotolabJob,
        PhotolabJobDiskEstimate, PhotolabJobId, PhotolabJobKind, PhotolabJobState, PhotolabStage,
        PhotolabStageKind,
    };
