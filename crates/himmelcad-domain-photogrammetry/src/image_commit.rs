...
use crate::photolab_images::{DiscoveredPhoto, ProjectedPhotoReference};
use crate::photolab_products::{ImageProductStatus, ImageProductTag};
use crate::photolab_project::{JournalCommandState, PhotolabJournalEntry, PhotolabProjectManifest};
use himmelcad_model::entity::{EntityId, EntityKind, EntitySnapshot, Vec3, VisibilityState};
...
use himmelcad_transform::photolab_crs::{FrozenImportTransformation, ProjectReferenceFrame};
...
fn validate_request(params: &CommitImagesParams) -> Result<(), ImageCommitError> {
    ...
    for item in &params.images {
        ...
        let status = ImageProductStatus {
            image_id: crate::photolab_matching::ImageId(0),
...
mod tests {
    ...
    use crate::photolab_images::{PhotoFormat, PhotoMetadata, ProjectedPhotoReference};
