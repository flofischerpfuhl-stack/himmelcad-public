...
use himmelcad_model::entity::{EntityId, EntitySnapshot, Vec3};
...
pub fn initial_photolab_manifest(
    ...
    entities.insert(
        ...
        entity(
            root_id.clone(),
            himmelcad_model::entity::EntityKind::ProjectRoot,
            name.clone(),
            None,
            vec![survey_id.clone()],
        ),
    ...
    entities.insert(
        ...
        entity(
            survey_id.clone(),
            himmelcad_model::entity::EntityKind::Survey,
            "Survey 01".to_owned(),
            Some(root_id.clone()),
    ...
    entities.insert(
        ...
        entity(
            images_id,
            himmelcad_model::entity::EntityKind::ImageCollection,
            "Images · 0".to_owned(),
    ...
    entities.insert(
        ...
        entity(
            reference_id,
            himmelcad_model::entity::EntityKind::Group,
...
fn entity(
    id: EntityId,
    kind: himmelcad_model::entity::EntityKind,
    name: String,
    ...
    EntitySnapshot {
        ...
        parent,
        children,
        visibility: himmelcad_model::entity::VisibilityState::default(),
...
mod tests {
    ...
    fn initial_manifest_contains_explicit_photolab_tree() {
        ...
        assert!(manifest
            .entities
            .values()
            .any(|entity| entity.kind == himmelcad_model::entity::EntityKind::ImageCollection));
    }
