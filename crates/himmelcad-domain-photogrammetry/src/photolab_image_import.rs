...
use crate::photolab_capture::{CaptureCapabilityInventory, CaptureDecodeSupport};
...
mod tests {
    ...
    use super::*;
    use crate::photolab_images::HeightSemanticReference;
    ...
    fn parses_synthetic_exif_camera_dimensions_time_focal_orientation_and_gps() {
        ...
        assert_eq!(
            ...
            crate::photolab_capture::CaptureDeviceClass::Drone
        );
