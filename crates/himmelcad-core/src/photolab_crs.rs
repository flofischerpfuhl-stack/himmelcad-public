...
//!
//! Product-neutral CRS declarations live in himmelcad-transform; this module retains the
//! PhotoLab import decision, validation, and frozen audit policy.
...
pub use himmelcad_transform::crs::{
    ...
    RequiredTransformationGrid, TransformationGridKind, VerticalCrsSelection,
    VerticalOperationMode, DEFAULT_ALLOW_BALLPARK, DEFAULT_ONLY_BEST,
};
