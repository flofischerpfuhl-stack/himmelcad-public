...
pub struct PreparedSimilarityTransform {
    pub scale: f64,
    pub rotation: [f64; 9],
...
pub fn tile_brush_ply(
    source: &Path,
    output_root: &Path,
    project_transform: Option<PreparedSimilarityTransform>,
...
fn transform_splat(splat: &mut Splat, transform: PreparedSimilarityTransform) {
