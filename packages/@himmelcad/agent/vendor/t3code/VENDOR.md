...
| Upstream file | Himmel:CAD file | Modification |
| --- | --- | --- |
...
| `apps/web/src/components/chat/MessagesTimeline.logic.ts` | `src/vendor/t3code/stableRows.ts`, `src/timeline.ts` | Stable keyed row derivation/reference reuse generalized to Himmel:CAD events. |
