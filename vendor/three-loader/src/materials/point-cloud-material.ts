...
// Himmelcad vendor patch: webpack `require('./shaders/*.vert').default` →
// Vite-style `?raw` imports. See vendor/three-loader/VENDOR.md.
import pointcloudVertSource from './shaders/pointcloud.vert?raw';
import pointcloudFragSource from './shaders/pointcloud.frag?raw';
...
export class PointCloudMaterial extends RawShaderMaterial {
  ...
  updateShaderSource(): void {
    this.vertexShader = this.applyDefines(pointcloudVertSource);
    this.fragmentShader = this.applyDefines(pointcloudFragSource);
