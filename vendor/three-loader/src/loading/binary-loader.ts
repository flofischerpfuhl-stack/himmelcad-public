...
// Himmelcad vendor patch: webpack `require('../workers/*.worker.js').default`
// → Vite `?worker` import. See vendor/three-loader/VENDOR.md.
...
export class BinaryLoader {
  ...
  public static readonly WORKER_POOL = new WorkerPool(32, BinaryDecoderWorker);
