...
impl<'a> DwgObjectWriter<'a> {
    ...
    fn write_mtext(&mut self, e: &MText) {
        ...
        if self.version.r2018_plus(self.dxf_version) {
            ...
            if !e.is_annotative {
                ...
                // X-axis dir 3BD
                let x_dir_redundant = Vector3::new(e.rotation.cos(), e.rotation.sin(), 0.0);
    ...
    fn write_dimension_ordinate(&mut self, d: &DimensionOrdinate) {
        ...
        self.writer.write_3bit_double(d.base.definition_point);
    ...
    fn write_ole2frame(&mut self, e: &Ole2Frame) {
        ...
        self.writer.write_bit_long(e.binary_data.len() as i32);
        self.writer.write_bytes(&e.binary_data);
    ...
    fn write_multileader_annotation_context(
        &mut self,
